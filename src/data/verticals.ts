...
export const verticals: Vertical[] = [
  {
    ...
    name: "Auto Insurance",
    category: "Insurance",
    summary: "Drivers comparing rates after hikes or life changes.",
    description:
      "Shoppers call when premiums jump, a policy lapses, or they need state-minimum vs full coverage clarified. Buy on CPL or cost per call with filters for state, age band, coverage type, and exclusive vs shared transfers.",
  ...
  },
  {
    ...
    description:
      "Demand spikes in open enrollment and Special Enrollment Periods, then continues year-round for short-term and individual products. Filter by product type, state licensing, and hours so your licensed agents only take calls they can place.",
  ...
  },
  {
    ...
    description:
      "Callers often want face amount, term length, and underwriting path explained before they buy. Match on product (term vs permanent), age, and exclusive vs shared so your agents aren't fighting the same prospect on three lines.",
  ...
  },
  {
    ...
    description:
      "Intent rises at purchase, renewal, and after carrier non-renewals or rate shocks. Geo and property-type filters matter — coastal, wildfire, and high-value homes need different buyer capacity than standard dwelling policies.",
  ...
  },
  {
    ...
    description:
      "Volume concentrates in Annual Enrollment Period, with a smaller OEP window and limited year-round SEP traffic. CMS marketing rules shape creative and consent; buyers need licensed MA agents and hours that match senior call patterns.",
  ...
  },
  {
    ...
    description:
      "Callers are typically older, phone-first, and deciding on smaller face amounts faster than term life. Age bands, state, and exclusive routing keep your FE agents on conversations they can underwrite and close.",
  ...
  },
  {
    ...
    description:
      "Qualified PI callers usually need screening for injury type, timing vs statute of limitations, and whether they already retained counsel. Exclusive transfers and intake-hour filters protect firm capacity on high-value case types.",
  ...
  },
  {
    ...
    description:
      "Demand follows docket calendars and media waves — product exposure questions, diagnosis criteria, and prior representation screens drive qualification. Buy filtered calls or CPL with campaign-specific consent and case-type rules.",
  ...
  },
  {
    ...
    description:
      "Minimum debt thresholds are the core qualifier — callers below your floor burn intake time. Filter by debt amount, unsecured vs secured mix, and state so your phone team only talks to enrollable prospects.",
  ...
  },
  {
    ...
    description:
      "Homeownership, roof condition, utility territory, and sun exposure decide whether a call is worth an appointment. Geo and homeowner filters matter more here than raw volume — shared vs exclusive depends on your setter capacity.",
  ...
  },
  {
    ...
    description:
      "Demand spikes on heat waves and cold snaps; replacement vs repair intent changes ticket size and talk track. Cap concurrency and geo tightly so your techs aren't booked out while calls keep landing.",
  ...
  },
  {
    ...
    description:
      "Storm corridors and hail seasons create short, intense demand windows. Homeownership, roof age, and insurance-claim intent are the usual filters — buyers who ignore geo and weather timing overspend on soft weeks.",
  ...
  },
  {
    ...
    description:
      "Callers often weigh DIY vs professionally monitored, and whether they rent or own. Product filters (equipment vs monitoring), exclusivity, and hours keep dealer and brand teams on installable appointments.",
  ...
  },
  {
    ...
    description:
      "Rate moves flip purchase vs refi mix quickly; credit band and loan purpose are the filters that protect loan-officer time. Buy CPL or cost-per-call with product and state rules matched to what your team can close.",
  ...
  },
  {
    ...
    description:
      "Minimum tax debt and filing status usually decide whether a caller is enrollable. State rules and product fit (resolution vs prep) matter — buyers who skip those filters pay for conversations they can't help.",
  ...
  },
  {
    ...
    description:
      "Callers ask about program fit, start dates, and financing — enrollment teams need program and geo filters so transfers match what the school actually offers. CPL and cost-per-call both work when qualification happens before the handoff.",
